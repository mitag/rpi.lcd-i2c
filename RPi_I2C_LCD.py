...
# 2016-02-15
# Modified by mitag (Michael Taggatz)
# 2017-12-06
"""
import smbus
from time import *
...
# some const
# LCD Address and I2C Bus number
I2C_PORT = 1
LCD_ADDRESS = 0x27
...
class LCD:
    def __init__(self, i2c_addr=LCD_ADDRESS, port=I2C_PORT):
        """
        ...
        self._lcd_device = I2cDevice(i2c_addr, port)
        # init display
        self.write_cmd(0x03)
        self.write_cmd(0x03)
        self.write_cmd(0x03)
